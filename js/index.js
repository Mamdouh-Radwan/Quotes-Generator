...
function quotesGen(){
    ...
    if (index == lastIndex ) {
      if(lastIndex == quotesArray.length+1){
        index-=1;
      }
      else{
        index+=1;
      ...
      document.getElementById('quoteOutput').innerHTML = '<i class="fa-solid fa-quote-left text-success"></i>' + quotesArray[index].quote + '<i class="fa-solid fa-quote-right text-success"></i>';
      document.getElementById('authorOutput').innerHTML = '--' + quotesArray[index].author;
    }
...
// var author = '--';
    // var authorD = document.getElementById('authorOutput');
    // for (var i = 0; i <= quotesArray[index].author.length; i++) {
    //   console.log(author); 
    //   author += quotesArray[index].author[i];
    //   // authorAnimation(author);
    //   setTimeout(function(){authorD.innerHTML = author} , i*100);
    // }
    // lastIndex = index;
    // }
// function authorAnimation(author) {
//   document.getElementById('authorOutput').innerHTML = author;
// }
// document.getElementById('quoteOutput').style.color="blue"
